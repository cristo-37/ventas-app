...
class Inventario(Frame):
    ...
    def validación(self, nombre, prov, precio, costo, stock):
    ...
    def mostrar(self):
        ...
        for elem in result:
            try:
                precio_cop = "{:,.0f} PEN".format(float(elem[3])) if elem [3] else ""
                costo_cop = "{:,.0f} PEN".format(float(elem[3])) if elem [4] else ""
            except ValueError:
                precio_cop = elem[3]
                costo_cop = elem[4]
    ...
    def actualizar_inventario(self):
        ...
        messagebox.showerror("Actulizacion", "El inventario ha sido actualizado correctamente")  
    ...
    def registrar(self):
        ...
        if self.validación(nombre, prov, precio, costo, stock):
            try:
